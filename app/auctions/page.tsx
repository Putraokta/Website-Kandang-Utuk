...
export default function AuctionsPage() {
  ...
  const auctions = [
    ...
    {
      id: 2,
      name: "Ayam Broiler Premium Siap Potong",
    ...
    {
      id: 3,
      name: "Ayam Petelur Unggul Produktif",
      currentBid: "Rp 95.000",
      timeLeft: "1 jam 45 menit",
      image: "/placeholder.svg?height=150&width=150",
      bidders: 15,
      startPrice: "Rp 60.000",
      category: "petelur",
      weight: "1.8 kg",
      age: "8 bulan",
      location: "Depok",
    ...
    {
      id: 5,
      name: "Ayam Kate Hias Cantik",
      currentBid: "Rp 45.000",
      timeLeft: "3 jam 10 menit",
      image: "/placeholder.svg?height=150&width=150",
      bidders: 6,
      startPrice: "Rp 25.000",
      category: "hias",
      weight: "0.8 kg",
      age: "4 bulan",
      location: "Bekasi",
